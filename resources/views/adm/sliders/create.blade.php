				...
				<div class="row">
					...
					<div class="file-field input-field col s6">
						...
						<div class="file-path-wrapper">
						    {!! Form::text('imagen',null, ['class'=>'file-path ', 'placeholder' => 'Recomendado (1400 x 511)']) !!}
						</div>
					</div>
				</div>
				<div class="row">
					<div class="input-field col l6 s12">
						{!! Form::select('seccion', ['home' => 'home', 'empresa' => 'empresa', 'mantenimiento' => 'mantenimiento'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione sección']) !!}
					</div>
					<div class="input-field col l6 s12">
						{!!Form::label('Orden:')!!}
